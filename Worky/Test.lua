...
SaveTheme = {}
local themes = {
	index = {'Dark', 'Amethyst', 'Ocean', 'Forest', 'Sunset', 'Crimson', 'Ice'},
	...
	Ocean = {
		['Shadow'] = Color3.fromRGB(10, 25, 35),
		['Background'] = Color3.fromRGB(15, 35, 50),
		['Page'] = Color3.fromRGB(12, 30, 45),
		['Main'] = Color3.fromRGB(41, 128, 185),
		['Text & Icon'] = Color3.fromRGB(236, 240, 241),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(20, 40, 55),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(30, 80, 110),
					['Toggle Value'] = Color3.fromRGB(52, 152, 219),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(25, 50, 70),
					['Toggle Value'] = Color3.fromRGB(30, 60, 80),
				}
			},
			['Label'] = {
				['Background'] = Color3.fromRGB(20, 40, 55),
			...
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(20, 40, 55),
				['Value Background'] = Color3.fromRGB(15, 35, 50),
				['Value Stroke'] = Color3.fromRGB(236, 240, 241),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(15, 35, 50),
					['Search'] = Color3.fromRGB(25, 50, 70),
					['Item Background'] = Color3.fromRGB(30, 60, 85),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(20, 40, 55),
				['Value Background'] = Color3.fromRGB(15, 35, 50),
				['Value Stroke'] = Color3.fromRGB(236, 240, 241),
				['Slider Bar'] = Color3.fromRGB(30, 80, 110),
				['Slider Bar Value'] = Color3.fromRGB(52, 152, 219),
				['Circle Value'] = Color3.fromRGB(236, 240, 241)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(20, 40, 55)), ColorSequenceKeypoint.new(1, Color3.fromRGB(20, 40, 55))},
				['Background Code'] = Color3.fromRGB(30, 60, 85),
				['Background Code Value'] = Color3.fromRGB(20, 50, 70),
				['ScrollingFrame Code'] = Color3.fromRGB(100, 181, 246)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(20, 40, 55),
				['Click'] = Color3.fromRGB(236, 240, 241)
			},
			['Textbox'] = {
				['Background'] = Color3.fromRGB(20, 40, 55),
				['Value Background'] = Color3.fromRGB(15, 35, 50),
			...
			['Color Picker'] = {
				...
				['Color Select'] = {
					['Background'] = Color3.fromRGB(15, 35, 50),
					['UIStroke'] = Color3.fromRGB(236, 240, 241),
				}
			}
		}
	},
	Forest = {
		['Shadow'] = Color3.fromRGB(18, 25, 20),
		['Background'] = Color3.fromRGB(25, 35, 28),
		['Page'] = Color3.fromRGB(20, 30, 24),
		['Main'] = Color3.fromRGB(76, 175, 80),
		['Text & Icon'] = Color3.fromRGB(245, 245, 245),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(30, 40, 33),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(46, 125, 50),
					['Toggle Value'] = Color3.fromRGB(102, 187, 106),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(35, 48, 38),
					['Toggle Value'] = Color3.fromRGB(40, 55, 43),
				}
			},
			['Label'] = {
				['Background'] = Color3.fromRGB(30, 40, 33),
			...
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(30, 40, 33),
				['Value Background'] = Color3.fromRGB(25, 35, 28),
				['Value Stroke'] = Color3.fromRGB(245, 245, 245),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(25, 35, 28),
					['Search'] = Color3.fromRGB(35, 48, 38),
					['Item Background'] = Color3.fromRGB(40, 55, 43),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(30, 40, 33),
				['Value Background'] = Color3.fromRGB(25, 35, 28),
				['Value Stroke'] = Color3.fromRGB(245, 245, 245),
				['Slider Bar'] = Color3.fromRGB(46, 125, 50),
				['Slider Bar Value'] = Color3.fromRGB(102, 187, 106),
				['Circle Value'] = Color3.fromRGB(245, 245, 245)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(30, 40, 33)), ColorSequenceKeypoint.new(1, Color3.fromRGB(30, 40, 33))},
				['Background Code'] = Color3.fromRGB(40, 55, 43),
				['Background Code Value'] = Color3.fromRGB(32, 45, 35),
				['ScrollingFrame Code'] = Color3.fromRGB(129, 199, 132)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(30, 40, 33),
				['Click'] = Color3.fromRGB(245, 245, 245)
			},
			['Textbox'] = {
				['Background'] = Color3.fromRGB(30, 40, 33),
				['Value Background'] = Color3.fromRGB(25, 35, 28),
			...
			['Color Picker'] = {
				...
				['Color Select'] = {
					['Background'] = Color3.fromRGB(25, 35, 28),
					['UIStroke'] = Color3.fromRGB(245, 245, 245),
				}
			}
		}
	},
	Sunset = {
		['Shadow'] = Color3.fromRGB(30, 20, 15),
		['Background'] = Color3.fromRGB(40, 28, 22),
		['Page'] = Color3.fromRGB(35, 25, 20),
		['Main'] = Color3.fromRGB(255, 107, 53),
		['Text & Icon'] = Color3.fromRGB(255, 245, 235),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(45, 32, 26),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(180, 70, 30),
					['Toggle Value'] = Color3.fromRGB(255, 138, 76),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(50, 38, 32),
					['Toggle Value'] = Color3.fromRGB(60, 45, 38),
				}
			},
			['Label'] = {
				['Background'] = Color3.fromRGB(45, 32, 26),
			...
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(45, 32, 26),
				['Value Background'] = Color3.fromRGB(40, 28, 22),
				['Value Stroke'] = Color3.fromRGB(255, 245, 235),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(40, 28, 22),
					['Search'] = Color3.fromRGB(50, 38, 32),
					['Item Background'] = Color3.fromRGB(60, 45, 38),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(45, 32, 26),
				['Value Background'] = Color3.fromRGB(40, 28, 22),
				['Value Stroke'] = Color3.fromRGB(255, 245, 235),
				['Slider Bar'] = Color3.fromRGB(180, 70, 30),
				['Slider Bar Value'] = Color3.fromRGB(255, 138, 76),
				['Circle Value'] = Color3.fromRGB(255, 245, 235)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(45, 32, 26)), ColorSequenceKeypoint.new(1, Color3.fromRGB(45, 32, 26))},
				['Background Code'] = Color3.fromRGB(60, 45, 38),
				['Background Code Value'] = Color3.fromRGB(48, 36, 30),
				['ScrollingFrame Code'] = Color3.fromRGB(255, 183, 77)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(45, 32, 26),
				['Click'] = Color3.fromRGB(255, 245, 235)
			},
			['Textbox'] = {
				['Background'] = Color3.fromRGB(45, 32, 26),
				['Value Background'] = Color3.fromRGB(40, 28, 22),
			...
			['Color Picker'] = {
				...
				['Color Select'] = {
					['Background'] = Color3.fromRGB(40, 28, 22),
					['UIStroke'] = Color3.fromRGB(255, 245, 235),
				}
			}
		}
	},
	Crimson = {
		['Shadow'] = Color3.fromRGB(25, 12, 15),
		['Background'] = Color3.fromRGB(35, 18, 22),
		['Page'] = Color3.fromRGB(30, 15, 20),
		['Main'] = Color3.fromRGB(220, 53, 69),
		['Text & Icon'] = Color3.fromRGB(255, 240, 245),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(40, 22, 28),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(150, 35, 45),
					['Toggle Value'] = Color3.fromRGB(220, 53, 69),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(45, 28, 35),
					['Toggle Value'] = Color3.fromRGB(55, 35, 42),
				}
			},
			['Label'] = {
				['Background'] = Color3.fromRGB(40, 22, 28),
			...
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(40, 22, 28),
				['Value Background'] = Color3.fromRGB(35, 18, 22),
				['Value Stroke'] = Color3.fromRGB(255, 240, 245),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(35, 18, 22),
					['Search'] = Color3.fromRGB(45, 28, 35),
					['Item Background'] = Color3.fromRGB(55, 35, 42),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(40, 22, 28),
				['Value Background'] = Color3.fromRGB(35, 18, 22),
				['Value Stroke'] = Color3.fromRGB(255, 240, 245),
				['Slider Bar'] = Color3.fromRGB(150, 35, 45),
				['Slider Bar Value'] = Color3.fromRGB(220, 53, 69),
				['Circle Value'] = Color3.fromRGB(255, 240, 245)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(40, 22, 28)), ColorSequenceKeypoint.new(1, Color3.fromRGB(40, 22, 28))},
				['Background Code'] = Color3.fromRGB(55, 35, 42),
				['Background Code Value'] = Color3.fromRGB(43, 26, 33),
				['ScrollingFrame Code'] = Color3.fromRGB(240, 98, 146)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(40, 22, 28),
				['Click'] = Color3.fromRGB(255, 240, 245)
			},
			['Textbox'] = {
				['Background'] = Color3.fromRGB(40, 22, 28),
				['Value Background'] = Color3.fromRGB(35, 18, 22),
			...
			['Color Picker'] = {
				...
				['Color Select'] = {
					['Background'] = Color3.fromRGB(35, 18, 22),
					['UIStroke'] = Color3.fromRGB(255, 240, 245),
				}
			}
		}
	},
	Ice = {
		['Shadow'] = Color3.fromRGB(18, 25, 30),
		['Background'] = Color3.fromRGB(22, 32, 40),
		['Page'] = Color3.fromRGB(20, 28, 35),
		['Main'] = Color3.fromRGB(100, 181, 246),
		['Text & Icon'] = Color3.fromRGB(224, 247, 250),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(26, 38, 48),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(60, 120, 160),
					['Toggle Value'] = Color3.fromRGB(129, 212, 250),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(32, 45, 55),
					['Toggle Value'] = Color3.fromRGB(38, 52, 62),
				}
			},
			['Label'] = {
				['Background'] = Color3.fromRGB(26, 38, 48),
			...
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(26, 38, 48),
				['Value Background'] = Color3.fromRGB(22, 32, 40),
				['Value Stroke'] = Color3.fromRGB(224, 247, 250),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(22, 32, 40),
					['Search'] = Color3.fromRGB(32, 45, 55),
					['Item Background'] = Color3.fromRGB(38, 52, 62),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(26, 38, 48),
				['Value Background'] = Color3.fromRGB(22, 32, 40),
				['Value Stroke'] = Color3.fromRGB(224, 247, 250),
				['Slider Bar'] = Color3.fromRGB(60, 120, 160),
				['Slider Bar Value'] = Color3.fromRGB(129, 212, 250),
				['Circle Value'] = Color3.fromRGB(224, 247, 250)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(26, 38, 48)), ColorSequenceKeypoint.new(1, Color3.fromRGB(26, 38, 48))},
				['Background Code'] = Color3.fromRGB(38, 52, 62),
				['Background Code Value'] = Color3.fromRGB(28, 42, 52),
				['ScrollingFrame Code'] = Color3.fromRGB(179, 229, 252)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(26, 38, 48),
				['Click'] = Color3.fromRGB(224, 247, 250)
			},
			['Textbox'] = {
				['Background'] = Color3.fromRGB(26, 38, 48),
				['Value Background'] = Color3.fromRGB(22, 32, 40),
			...
			['Color Picker'] = {
				...
				['Color Select'] = {
					['Background'] = Color3.fromRGB(22, 32, 40),
					['UIStroke'] = Color3.fromRGB(224, 247, 250),
				}
			}
		}
	},
...
for i,v in pairs(game.CoreGui:GetChildren()) do
	if v.Name == "WorkyLibrary" then
		v:Destroy()
	end
end

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "WorkyLibrary"
...
function Library:setTheme(st)
	...
	local IconList = loadstring(game:HttpGet('https://raw.githubusercontent.com/Utkaky/CataClysm/refs/heads/main/Worky/assets'))()
	function gl(i)
...
function Library:Window(p)
	...
	Frame_5.Size = UDim2.new(1, 0,0, 0)
...
function Tabs:Line()
	...
	local connection = RunService.RenderStepped:Connect(function()
		...
		local centerX = linePos.X + lineSize.X / 2
		local centerY = linePos.Y + lineSize.Y / 2
		
		local distance = math.sqrt((mouseX - centerX)^2 + (mouseY - centerY)^2)
		
		if distance <= proximityDistance and not isNear then
			isNear = true
			TweenService:Create(Line, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
				BackgroundTransparency = 0.700
			}):Play()
		elseif distance > proximityDistance and isNear then
			isNear = false
			TweenService:Create(Line, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
...
function Tabs:Tab(p)
	...
	-- PROXIMITY HOVER PARA TAB
	local proximityDistance = 40
	local isNear = false
	local mouse = Players.LocalPlayer:GetMouse()
	...
	local connection = RunService.RenderStepped:Connect(function()
		...
		local tabPos = Tab_1.AbsolutePosition
		local tabSize = Tab_1.AbsoluteSize
		local mouseX = mouse.X
		local mouseY = mouse.Y
		
		local centerX = tabPos.X + tabSize.X / 2
		local centerY = tabPos.Y + tabSize.Y / 2
		
		local distance = math.sqrt((mouseX - centerX)^2 + (mouseY - centerY)^2)
		
		if distance <= proximityDistance and not isNear then
			isNear = true
			TweenService:Create(Title_3, TweenInfo.new(0.15, Enum.EasingStyle.Linear), {
				TextTransparency = 0.4
			}):Play()
			TweenService:Create(ImageLabel_2, TweenInfo.new(0.15, Enum.EasingStyle.Linear), {
	...
	Tab_1.AncestryChanged:Connect(function()
		if not Tab_1:IsDescendantOf(game) then
			connection:Disconnect()
		end
	end)
...
function Func:Keybind2(p)
    local Title = p.Title or 'null'
    local Desc = p.Desc or ''
    local Image = p.Image or ''
    local Key = p.Key or Enum.KeyCode.E
    local Hold = p.Hold or false
    local Callback = p.Callback or function() end
    local Flag = p.Flag or nil
    ...
    U.InputBegan:Connect(function(input, gameProcessed)
        ...
        if Binding then
            ...
            if (input.KeyCode == Key or input.UserInputType == Key) and not gameProcessed then
                if Hold then
                    Holding = true
    ...
    U.InputEnded:Connect(function(input, gameProcessed)
        if gameProcessed then return end
        
        if (input.KeyCode == Key or input.UserInputType == Key) and Hold and Holding then
            Holding = false
            pcall(Callback, Holding)
        end
    end)
